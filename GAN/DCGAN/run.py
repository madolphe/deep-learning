# @TODO: add tensorboard vizualisation of loss (and see images could be saved and displayed within the tool)
# @TODO: add argument parsers
import tensorflow as tf
from GAN.DCGAN.model_DCGAN import generative_net, discriminative_net, discriminator_loss, generator_loss, \
                         discriminator_optimizer, generator_optimizer, dcgan_train_step
from Datas.get_victorian_dataset import dataset
import time
...
def train(dataset, epochs, batch_size):
    for epoch in range(epochs):
        ...
        for image_batch in dataset.batch(batch_size):
            i += 1
            dcgan_train_step(image_batch, batch_size, noise_dim)
